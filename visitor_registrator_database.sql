...
@PASSWORD VARCHAR(30)
AS
INSERT INTO USUARIOS VALUES(@NOMBRE, @APELLIDO, @FECHA_NACIMIENTO, @PERMISOS, @USERNAME, @PASSWORD)
GO


--PROCEDIMIENTO EDITAR USUARIO
CREATE PROC SP_EDITANDOUSUARIO
@ID INT,
@NOMBRE VARCHAR(30),
@APELLIDO VARCHAR(30),
@FECHA_NACIMIENTO DATETIME,
...
@PASSWORD VARCHAR(30)
AS
UPDATE USUARIOS SET NOMBRE = @NOMBRE, APELLIDO = @APELLIDO, FECHA_NACIMIENTO = @FECHA_NACIMIENTO,
PERMISOS = @PERMISOS, USERNAME = @USERNAME, PASSWORD = @PASSWORD
WHERE ID = @ID
